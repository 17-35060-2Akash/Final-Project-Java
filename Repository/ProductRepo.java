...
public class ProductRepo implements IProductRepo
{
	...
	{
		String query = "UPDATE products SET productName='"+p.getName()+"', count = '"+p.getCount()+"', price= "+p.getPrice()+" WHERE productId='"+p.getProductId()+"'";
	...
	{
		Product prd = null;
		String query = "SELECT `productName`, `count`, `price` FROM `product` WHERE `productId`='"+productId+"';";     
		try
		{
